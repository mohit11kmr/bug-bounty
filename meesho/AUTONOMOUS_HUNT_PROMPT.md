...
- [ 80] **api_surface** `https://supplier.meesho.com/panel/v3/new/root/login?redirect=%2Fpanel%2Fv3%2Fnew%2Ffulfillment%2F3hy5q%2Fquality-dashboard`
- [ 55] **auth** `https://admin.meeshosupply.com/api/google/oauth?redirect=%2F`
- [ 55] **auth** `https://admin.meeshosupply.com/login?redirect=%2F`
- [ 50] **api_surface** `https://supplier.meesho.com/panel/v2/new/login`
- [ 50] **api_surface** `https://supplier.meesho.com/panel/v2/new/login?distinct_id=17d7534a8cd295-0b6d89ab8aa525-1f241205-186a00-17d7534a8ce31a`
- [ 50] **api_surface** `https://supplier.meesho.com/panel/v3/new/cataloging/3hy5q/catalogs`
...
4. **Prepare Report Artifact**:
   - Save PoC evidence to `evidence/findings/meesho_bbp/`.
