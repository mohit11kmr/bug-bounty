...
|---|---|---|---|
| `moneybird.com` | url | 16186 | critical |
| `moneybirdstorage.com` | url | 16187 | critical |
| `com.moneybird.Moneybird` | apple_store_app_id | 16188 | critical |
| `com.moneybird.android` | google_play_app_id | 16189 | critical |
...
In the public information concerning the problem reported, we will give your name as the discoverer of the problem (unless you desire otherwise), and
 - We strive to resolve all problems as quickly as possible, and we would like to play an active role in the ultimate publication on the problem after it is resolv...
